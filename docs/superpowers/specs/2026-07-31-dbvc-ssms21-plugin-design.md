...
* **Core Modules**:
  ...
  * `StateTracker`: 변경 캐시 관리. Object Explorer 오버레이 상태 업데이트는 원안에는 있었으나 **미구현·보류 상태**다 (Feature 10, 사유는 [2026-08-01-dbvc-object-explorer-overlay.md](../plans/2026-08-01-dbvc-object-explorer-overlay.md) 참고).
